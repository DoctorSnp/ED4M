...
#define RTSOAL_AUXLIB 4
    ...
    #define PACKED_BEGIN __pragma(pack(push, 4))
    #define PACKED
...
typedef void *(* LPRTS_GETOBJ)(void *DLL,const void *obj,short ActLoc,RTSObjType Code,int Index, int SubIndex);
typedef void *(* LPRTS_GETOBJBYNAME)(void *DLL,const void *obj,short ActLoc,RTSObjType Code,const wchar_t *Name, int SubIndex);
typedef void *(* LPRTS_GETOBJLOCO)(void *DLL,const Locomotive *loco,RTSObjType Code,int Index, int SubIndex);
typedef void *(* LPRTS_GETOBJBYNAMELOCO)(void *DLL,const Locomotive *loco,RTSObjType Code,const wchar_t *Name, int SubIndex);
typedef void *(* LPRTS_GETOBJCAB)(void *DLL,const Cabin *cab,RTSObjType Code,int Index, int SubIndex);
typedef void *(* LPRTS_GETOBJBYNAMECAB)(void *DLL,const Cabin *cab,RTSObjType Code,const wchar_t *Name, int SubIndex);
typedef int (* LPRTS_GETTRITEMS)(void *DLL,const Locomotive *loco,UINT Code,float Distance,TrackItemsItem *&items, UINT &Count);
...
extern LPRTS_GETINT RTSGetInteger ,
                    RTSSetIntegerG;
extern LPRTS_GETOBJ RTSGetObject;
extern LPRTS_GETOBJBYNAME RTSGetObjectByName;
extern LPRTS_GETOBJLOCO RTSGetLocoObject;
extern LPRTS_GETOBJBYNAMELOCO RTSGetLocoObjectByName;
extern LPRTS_GETOBJCAB RTSGetCabObject;
extern LPRTS_GETOBJBYNAMECAB RTSGetCabObjectByName;
extern LPRTS_GETTRITEMS RTSGetTrackItems;
extern LPRTS_GETNAMEDINT RTSGetNamedInteger;
extern LPRTS_GETSNDTRON RTSIsSMSTriggerOn;
...
struct TrackTDP{
 void *ds; Wagon *wag; TrackPDP *pos;
 void *Node;
 TrackTDP *next,*prev;
 float Time,Distance;
};
...
extern wchar_t _RTS_ParamBuf[128];
 ...
 */
 ...
 inline float GetParameter(wchar_t *name,float Default) const{
  EngineParam *p=(EngineParam *)RTSGetObjectByName(DLLHandle,this,RTSOAL_AUXLIB,RTSOT_EngExtParam,name,-1);
  if(p)
   return p->Value;
  return Default;
 };

 inline wchar_t *GetParameterAsString(wchar_t *name,const wchar_t *Default) const{
  EngineParam *p=(EngineParam *)RTSGetObjectByName(DLLHandle,this,RTSOAL_AUXLIB,RTSOT_EngExtParam,name,-1);
  if(p){
   if(p->str)
    return p->str;
 ...
 inline SMSObject *Sound() const{
  return (SMSObject *)RTSGetObject(DLLHandle,this,RTSOAL_AUXLIB,RTSOT_Sound,-1,-1);
 };

 inline const Locomotive *Loco() const{
  return (Locomotive *)RTSGetObject(DLLHandle,this,RTSOAL_AUXLIB,RTSOT_Loco,-1,-1);
 };
...
struct InternalLight{
 unsigned long Flags;
 AnimNode *obj;
 float Position[3],Points[3],Radius[3],Fade[4],
       SpotExp,ProjTrans;
 unsigned long Colour,ProjSize;
 void *light;
 unsigned int State,GlobalID;
 float AutoOnWorldLit,Attenuation[4];
};
 ...
 */
 ...
 double ZOrd;
 float BrakeCylinderPressure,TrainPipePressure,TrainPipeRate,ChargingPipePressure,
       HandbrakeValue;
 float Osc[8];
 Object *obj;
 TrackPDP TrPos[2];
...
struct Cabin: public DLLInterfaceObject{
 ...
 UINT SignalBlockCheckAhead,SignalNumLights,SignalNumAspects,
      SignalScripted;
 AnimNode * * Signals;
 unsigned int *SignalAspects,SignalAspects1;
 UINT NumAreas,NumPlanes,NumDoors,NumWindows,NumChairs,
      NumTexChanges,NumLights,NumScenes,NumSeats,NumLedges;
 SignalsInfo Signal;
 unsigned long Flags;
 ...
 inline int Switch(UINT ID){
  ActSwitch *sw=(ActSwitch *)RTSGetCabObject(DLLHandle,this,RTSOT_Switch,ID,-1);
  if(!sw)
   return -1;
  return sw->State;
 };
 ...
 int SwitchSub(UINT ID){
  CloseUpSubObject *sw=(CloseUpSubObject *)RTSGetCabObject(DLLHandle,this,RTSOT_ClsSub,ID,-1);
  if(!sw)
   return -1;
  return sw->State;
 };
 ...
 inline int SwitchSub(UINT sceneID,UINT objID){
  CloseUpSubObject *sw=(CloseUpSubObject *)RTSGetCabObject(DLLHandle,this,RTSOT_ClsSub,sceneID,objID);
  if(!sw)
   return -1;
  return sw->State;
 };
 ...
 inline void SetSwitch(UINT sceneID,UINT objID,float Value,bool SetBoth){
  CloseUpSubObject *o=(CloseUpSubObject *)RTSGetCabObject(DLLHandle,this,RTSOT_ClsSub,sceneID,objID);
  if(o){
   if(o->Type==1){
    o->Value=Value;
   }else{
 ...
 inline float GetSwitchFrame(UINT SwitchID){
  ActSwitch *sw=(ActSwitch *)RTSGetCabObject(DLLHandle,this,RTSOT_Switch,SwitchID,-1);
  if(sw){
   if(sw->Flags&64)
 ...
 inline FreeAnimation *FindAnim(wchar_t *name) const{
  return (FreeAnimation *)RTSGetCabObjectByName(DLLHandle,this,RTSOT_FreeAnim,name,-1);
 };
 ...
 inline TexChange *TextureChange(UINT TexChangeID){
  return (TexChange *)RTSGetCabObject(DLLHandle,this,RTSOT_TexChng,TexChangeID,-1);
 };

 inline InternalLight *LightInt(UINT LightID){
  return (InternalLight *)RTSGetCabObject(DLLHandle,this,RTSOT_IntLight,LightID,-1);
 };
};
 ...
 */
...
#ifdef RTS_NODIRECTOBJLINKS
 void *cab; UINT LibParam,StackSize;
 void *Slaves;
 void * *FirstInGroup,* *LastInGroup;
 void *locoA;
#else
 Cabin *cab; UINT LibParam,StackSize;
 Locomotive * *Slaves;
 ...
 inline void SwitchLight(USHORT ID,bool TurnOn,float Radius=0.0,unsigned long Colour=0) const;
 ...
 inline ActDoor *Door(UINT ID) const;
 inline int GetTrackItems(UINT Code,float Distance,
        TrackItemsItem *&res, UINT &Count) const;
...
struct Engine: public DLLInterfaceObject{
 ...
 float IndependentBrakeValue,TrainPipeRate,AuxilaryRate,MainResRate,ChargingRate,
       HandbrakePercent,DynamicBrakePercent,EPTvalue,UR;
...
inline void Exhaust
   (const DieselLocomotive *loco,USHORT ID,float Rate,float Magnitude,
    float Dispertion,ULONG Colour,float Mass)
{
  ExhaustContr *exh=(ExhaustContr *)RTSGetLocoObject(DLLHandle,loco,RTSOT_Exhaust,ID,-1);
  if(exh){
   if(Rate>=0.0)
    exh->Rate=Rate;
   if(Magnitude>=0.0)
...
inline void Locomotive::SwitchLight
 (USHORT ID,bool TurnOn,float Radius,unsigned long Colour) const
{
  LightObj *lgt=(LightObj *)RTSGetLocoObject(DLLHandle,this,RTSOT_Light,ID,-1);
  if(lgt){
   if(TurnOn)
    lgt->Flags|=8;
   else
...
inline Locomotive *Locomotive::SlaveLoco(UINT N) const{
 return (Locomotive *)RTSGetLocoObject(DLLHandle,this,RTSOT_SlaveLoco,N,-1);
};
...
inline int Locomotive::GetTrackItems(UINT Code,float Distance,
        TrackItemsItem *&items, UINT &Count) const
{
 if(RTSGetTrackItems)
...
inline AuxLibrary *Locomotive::GetAuxLibrary(wchar_t *Name) const{
 return (AuxLibrary *)RTSGetLocoObjectByName(DLLHandle,this,RTSOT_AuxLib,Name,-1);
};
 ...
 */
 ...
 float Speed[2],Var1[2],Var2[2],Var3[2],Var4[2],Var5[2],Var6[2],Var7[2],Var8[2],
       Distance[2],Trav[2],Accel[2],Radius[2];
 float Volume;
 void *Streams;
...
{
 SMSObject *soundCab=(SMSObject *)RTSGetLocoObject(DLLHandle,this,RTSOT_Sound,1,-1);
 if(soundCab)
...
{
 bool res=true;
 SMSObject *soundExt=(SMSObject *)RTSGetLocoObject(DLLHandle,this,RTSOT_Sound,0,-1);
 if(soundExt)
  res=soundExt->PostTrigger(N);
 return res;
};
...
inline int Locomotive::IsSMSTriggerOnEng(USHORT Code) const{
 SMSObject *soundObj=(SMSObject *)RTSGetLocoObject(DLLHandle,this,RTSOT_Sound,0,-1);
 if(soundObj)
...
inline int Locomotive::IsSMSTriggerOnCab(USHORT Code) const{
 SMSObject *soundObj=(SMSObject *)RTSGetLocoObject(DLLHandle,this,RTSOT_Sound,1,-1);
 if(soundObj)
   return soundObj->IsTriggerOn(Code);
 else
   return -5;
...
inline FreeAnimation *Locomotive::FindAnim(wchar_t *name) const{
 return (FreeAnimation *)RTSGetLocoObjectByName(DLLHandle,this,RTSOT_FreeAnim,name,-1);
};

inline float Locomotive::GetParameter(wchar_t *name,float Default) const{
  EngineParam *p=(EngineParam *)RTSGetLocoObjectByName(DLLHandle,this,RTSOT_EngExtParam,name,-1);
  if(p)
   return p->Value;
  return Default;
};

inline wchar_t *Locomotive::GetParameterAsString(wchar_t *name,const wchar_t *Default) const{
  EngineParam *p=(EngineParam *)RTSGetLocoObjectByName(DLLHandle,this,RTSOT_EngExtParam,name,-1);
  if(p){
   if(p->str)
    return p->str;
...
inline float GetLimit(float &l1,float &l2,float l3=-1.0)
{
 float l;
 l=l1;
